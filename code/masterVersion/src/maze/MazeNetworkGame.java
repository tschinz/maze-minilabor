 ...
 * @version 1.0
 */
public class MazeNetworkGame extends MazeGame {

	GameClient client = null;
	boolean isConnected = false;

	public MazeNetworkGame(MazeContainer mc) {
		...
		client = new GameClient() {
			...
			public void otherPlayerIncoming(String serverIP, Player yourAreThisPlayer, int mazeID) {							
				 ...
				 */
				if (yourAreThisPlayer == Player.PLAYER1)
					playerColor = "RED";
				if (yourAreThisPlayer == Player.PLAYER2)
					playerColor = "YELLOW";

				final String msg = "You're the " + playerColor + " player";
			...
			public void otherPlayerHasMoved(Direction d, Player p) {
				...
				/** 
				 * When the other player moves, move it
				 */
				movePlayer(d, p);
	...
	public static void main(String[] args) {		
		...
		new MazeNetworkGame(new MazeContainerTwoPlayers(10, 10, 1));			
	}
}
